<?php namespace App\Http\Controllers;
	...
	class AdminItemController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Uom Name","name"=>"uom_id","join"=>"gs_uom,id",'join'=>'gs_uom,nm'];
			...
			$this->form[] = ['label'=>'Unit of Major','name'=>'uom_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'gs_uom,nm'];
