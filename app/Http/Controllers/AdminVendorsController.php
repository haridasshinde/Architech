<?php namespace App\Http\Controllers;
	...
	class AdminVendorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Payment Template Id","name"=>"payment_template_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"payment_template,id"];
			//$this->form[] = ["label"=>"Bank Acc No","name"=>"bank_acc_no","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Phone No","name"=>"phone_no","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
