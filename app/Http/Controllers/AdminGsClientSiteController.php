<?php namespace App\Http\Controllers;
	...
	class AdminGsClientSiteController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Site Name","name"=>"site_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
