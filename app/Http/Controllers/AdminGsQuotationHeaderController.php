<?php namespace App\Http\Controllers;
	...
	class AdminGsQuotationHeaderController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Project Id','name'=>'project_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'project,id'];
			$this->form[] = ['label'=>'Client Id','name'=>'client_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'client,id'];
			$this->form[] = ['label'=>'Site Id','name'=>'site_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'site,id'];
			$this->form[] = ['label'=>'Attachment Details','name'=>'attachment_details','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
