<?php namespace App\Http\Controllers;
	...
	class AdminItemRawMaterialMappingController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gs_raw_material_item_mapping";
			...
			$this->form[] = ['label'=>'Qty','name'=>'qty','type'=>'number','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
