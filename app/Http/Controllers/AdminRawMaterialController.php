<?php namespace App\Http\Controllers;
	...
	class AdminRawMaterialController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gs_raw_material";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Name","name"=>"nm"];
			$this->col[] = ["label"=>"Model Name","name"=>"model_nm"];
			$this->col[] = ["label"=>"Uom Name","name"=>"uom_id","join"=>"gs_uom,nm"];
			$this->col[] = ["label"=>"Qty","name"=>"qty"];
			$this->col[] = ["label"=>"Default Vendor","name"=>"default_vendor"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'nm','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Model Name','name'=>'model_nm','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Nm","name"=>"nm","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Model Nm","name"=>"model_nm","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Default Vendor","name"=>"default_vendor","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
